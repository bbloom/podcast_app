...
use MediaPlatform\PodcastStudio\Management\Requests\PodcastLinkRequest;
...
class PodcastLinkController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('media_platform.podcast_studio.management.podcast_links.index', compact('links', 'sort', 'direction'));
    }
    ...
    {
        return view('media_platform.podcast_studio.management.podcast_links.create');
    }
    ...
    {
        return view(
            'media_platform.podcast_studio.management.podcast_links.show',
            ['link' => $podcast_link]
        );
    }
    ...
    {
        return view(
            'media_platform.podcast_studio.management.podcast_links.edit',
            ['link' => $podcast_link]
        );
    }
    ...
    {
        return view(
            'media_platform.podcast_studio.management.podcast_links.delete_confirm',
            ['link' => $podcast_link]
        );
    }
    ...
    public function attachIndex(PodcastEpisode $podcast_episode)
    {
        ...
        return view(
            'media_platform.podcast_studio.management.podcast_links.attach',
