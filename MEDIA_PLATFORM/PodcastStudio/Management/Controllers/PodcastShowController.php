...
use MediaPlatform\PodcastStudio\Management\Requests\PodcastShowRequest;
...
class PodcastShowController extends Controller
{
    ...
    {
        return view('media_platform.podcast_studio.management.podcast_shows.create');
    }
    ...
    public function edit(PodcastShow $podcast_show)
    {
        ...
        return view('media_platform.podcast_studio.management.podcast_shows.edit', ['show' => $podcast_show]);
    }
    ...
    public function deleteConfirm(PodcastShow $podcast_show)
    {
        ...
        return view('media_platform.podcast_studio.management.podcast_shows.delete_confirm', ['show' => $podcast_show]);
    }
