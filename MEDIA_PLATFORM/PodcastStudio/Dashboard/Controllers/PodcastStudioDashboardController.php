...
namespace MediaPlatform\PodcastStudio\Dashboard\Controllers;
...
class PodcastStudioDashboardController extends Controller
{
    ...
    public function show()
    {
        ...
        return view('media_platform.podcast_studio.dashboard.dashboard', compact(
            'draftsInProgress',
