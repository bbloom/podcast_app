...
namespace MediaPlatform\PodcastStudio\PostProduction\UploadRecording\Controllers;
...
class UploadRecordingController extends Controller
{
    ...
    public function show(PodcastEpisode $episode): View|RedirectResponse
    {
        ...
        return view('media_platform.podcast_studio.post_production.upload_recording.show', [
