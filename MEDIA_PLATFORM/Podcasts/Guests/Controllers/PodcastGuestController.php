...
class PodcastGuestController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('media_platform.podcasts.guests.index', compact('guests', 'sort', 'direction'));
    }
    ...
    {
        return view('media_platform.podcasts.guests.create');
    }
    ...
    {
        return view(
            'media_platform.podcasts.guests.show',
            ['guest' => $podcast_guest]
        );
    }
    ...
    {
        return view(
            'media_platform.podcasts.guests.edit',
            ['guest' => $podcast_guest]
        );
    }
    ...
    {
        return view(
            'media_platform.podcasts.guests.delete_confirm',
            ['guest' => $podcast_guest]
        );
    }
    ...
    public function attachEpisodeIndex(PodcastGuest $podcast_guest)
    {
        ...
        return view(
            'media_platform.podcasts.guests.attach_episode',
    ...
    public function attachGuestIndex(PodcastEpisode $podcast_episode)
    {
        ...
        return view(
            'media_platform.podcasts.guests.attach_guest',
