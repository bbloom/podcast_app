...
class PodcastEpisodeController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('media_platform.podcasts.publishing.episodes.index', [
            'episodes' => $episodes,
            'sort'     => $sortKey,
            'dir'      => $sortDir,
        ]);
    ...
    public function show(PodcastEpisode $podcast_episode): View|RedirectResponse
    {
        ...
        return view(
            'media_platform.podcasts.publishing.episodes.show',
    ...
    public function deleteConfirm(PodcastEpisode $podcast_episode): View|RedirectResponse
    {
        ...
        return view(
            'media_platform.podcasts.publishing.episodes.delete_confirm',
