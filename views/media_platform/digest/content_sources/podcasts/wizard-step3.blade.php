    ...
    <form method="POST" action="{{ route('digest-podcasts.create.step3.submit') }}"
        ...
        <div class="mb-8">
            <label class="block text-sm font-semibold text-gray-700 mb-3">
                Which lists should <span class="text-purple-700">{{ $podcastTitle }}</span> be added to?
            </label>
                ...
                <div class="bg-amber-50 border border-amber-300 rounded-lg p-4">
                    <div class="flex gap-3">
                        ...
                        <div class="text-sm text-amber-800">
                            ...
                            <p>You need at least one list before you can add a podcast. Create a list first, then come back to add this podcast.</p>
