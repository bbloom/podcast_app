<x-layouts.app title="Add a Podcast">
    ...
    <div class="bg-green-50 border border-green-300 rounded-lg p-6 mb-8 text-center">
        ...
        <p class="text-xl font-bold text-gray-800">Podcast Added Successfully!</p>
        <p class="text-lg text-gray-600 mt-1">
            <span class="font-semibold text-purple-700">{{ $title }}</span> has been added to your podcasts and assigned to {{ $listCount }} {{ Str::plural('list', $listCount) }}.
        </p>
    </div>
