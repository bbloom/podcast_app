<x-layouts.app title="Detach Podcast from List">
    ...
    <div class="bg-red-50 border border-red-300 rounded-lg p-4 mb-6">
        <div class="flex gap-3">
            ...
            <div class="text-sm text-red-800">
                ...
                <p>Detaching this podcast will permanently delete all summaries that were generated
                   for this podcast within this list. The podcast itself will not be deleted.</p>
            </div>
        </div>
    </div>
    ...
    <div class="border border-red-300 rounded-lg p-6 mb-8">
        <table class="text-sm text-gray-600 border-collapse">
            <tr>
                <td class="pr-8 py-2 text-gray-500 whitespace-nowrap font-semibold w-36">Podcast</td>
