<x-layouts.app title="Detach Channel from List">

    <div class="mb-8">
        <div class="flex items-center gap-2 text-sm text-gray-500 mb-6">
            <a href="{{ route('youtube.channels.index') }}" class="hover:text-purple-700 transition">← My Youtube Channels</a>
            <span>›</span>
            <a href="{{ route('youtube.channels.show', $source) }}" class="hover:text-purple-700 transition">{{ $source->title }}</a>
            <span>›</span>
    ...
    <div class="bg-red-50 border border-red-300 rounded-lg p-4 mb-6">
        <div class="flex gap-3">
            ...
            <div class="text-sm text-red-800">
                ...
                <p>Detaching this channel will permanently delete all summaries that were generated
                   for this channel within this list. The channel itself will not be deleted.</p>
            </div>
        </div>
    </div>
    ...
    <div class="border border-red-300 rounded-lg p-6 mb-8">
        <table class="text-sm text-gray-600 border-collapse">
            <tr>
                <td class="pr-8 py-2 text-gray-500 whitespace-nowrap font-semibold w-36">Channel</td>
    ...
    <div class="flex items-center justify-between">
        <a href="{{ route('youtube.channels.show', $source) }}"
        ...
        <form method="POST"
              action="{{ route('youtube.channels.list_sources.detach', [$source, $listSource]) }}">
            @csrf
            @method('DELETE')
            <button
                type="submit"
