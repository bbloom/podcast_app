    ...
    <form method="POST" action="{{ route('podcast_episodes.update', $episode) }}">
        ...
        <div class="mb-6">
            ...
            <select id="podcast_episode_status_lookup_id" name="podcast_episode_status_lookup_id" required
                ...
                @foreach ($statuses as $status)
                    <option value="{{ $status->id }}" {{ old('podcast_episode_status_lookup_id', $episode->podcast_episode_status_lookup_id) == $status->id ? 'selected' : '' }}>
                        {{ $status->title }}
                    </option>
                @endforeach
            </select>
        ...
        <div class="mb-6">
            <label for="itunes_episode" class="block text-sm font-semibold text-gray-700 mb-2">
                Episode Number <span class="font-normal text-gray-400">(0 = not set)</span>
            </label>
        ...
        <div class="mb-6">
            <label for="itunes_season" class="block text-sm font-semibold text-gray-700 mb-2">
                Season Number <span class="font-normal text-gray-400">(0 = not set)</span>
            </label>
        ...
        <div class="mb-6">
            ...
            <select id="itunes_episode_type" name="itunes_episode_type"
                ...
                <option value="full"    @selected(old('itunes_episode_type', $episode->itunes_episode_type) === 'full')>Full (default)</option>
        ...
        <div class="mb-6">
            <label for="itunes_enclosure_url" class="block text-sm font-semibold text-gray-700 mb-2">
                Enclosure URL <span class="font-normal text-gray-400">(optional)</span>
            </label>
        ...
        <div class="mb-6">
            <label for="itunes_enclosure_length" class="block text-sm font-semibold text-gray-700 mb-2">
                Enclosure Length <span class="font-normal text-gray-400">(optional — bytes)</span>
            </label>
        ...
        <div class="mb-6">
            ...
            <input type="text" id="itunes_enclosure_type" name="itunes_enclosure_type" value="{{ old('itunes_enclosure_type', $episode->itunes_enclosure_type) }}"
        ...
        <div class="mb-6">
            <label for="itunes_guid" class="block text-sm font-semibold text-gray-700 mb-2">
                GUID <span class="font-normal text-gray-400">(optional)</span>
            </label>
        ...
        <div class="mb-6">
            <label for="itunes_pubdate" class="block text-sm font-semibold text-gray-700 mb-2">
                Pub Date <span class="font-normal text-gray-400">(optional)</span>
            </label>
        ...
        <div class="mb-6">
            <label for="itunes_duration" class="block text-sm font-semibold text-gray-700 mb-2">
                Duration <span class="font-normal text-gray-400">(optional — e.g. "45:30")</span>
            </label>
        ...
        <div class="mb-6">
            <label for="itunes_subtitle" class="block text-sm font-semibold text-gray-700 mb-2">
                iTunes Subtitle <span class="font-normal text-gray-400">(optional)</span>
            </label>
            ...
            <div class="flex gap-3">
                <label class="flex-1 cursor-pointer">
                    <input type="radio" name="itunes_explicit" value="1"
                        {{ old('itunes_explicit', $episode->itunes_explicit ? '1' : '0') === '1' ? 'checked' : '' }} class="sr-only peer">
                ...
                <label class="flex-1 cursor-pointer">
                    <input type="radio" name="itunes_explicit" value="0"
                        {{ old('itunes_explicit', $episode->itunes_explicit ? '1' : '0') === '0' ? 'checked' : '' }} class="sr-only peer">
            ...
            <div class="flex gap-3">
                <label class="flex-1 cursor-pointer">
                    <input type="radio" name="itunes_block" value="1"
                        {{ old('itunes_block', $episode->itunes_block ? '1' : '0') === '1' ? 'checked' : '' }} class="sr-only peer">
                    <div class="border border-gray-300 rounded-lg px-4 py-3 text-sm font-semibold text-center text-gray-700 peer-checked:border-purple-700 peer-checked:text-purple-700 peer-checked:bg-purple-50 hover:border-gray-400 transition">Yes</div>
                </label>
                <label class="flex-1 cursor-pointer">
                    <input type="radio" name="itunes_block" value="0"
                        {{ old('itunes_block', $episode->itunes_block ? '1' : '0') === '0' ? 'checked' : '' }} class="sr-only peer">
                    <div class="border border-gray-300 rounded-lg px-4 py-3 text-sm font-semibold text-center text-gray-700 peer-checked:border-purple-700 peer-checked:text-purple-700 peer-checked:bg-purple-50 hover:border-gray-400 transition">No</div>
                </label>
            </div>
        </div>
            ...
            <div class="flex gap-3">
                <label class="flex-1 cursor-pointer">
                    <input type="radio" name="rss_feed_enabled" value="1"
                        {{ old('rss_feed_enabled', $episode->rss_feed_enabled ? '1' : '0') === '1' ? 'checked' : '' }} class="sr-only peer">
                    <div class="border border-gray-300 rounded-lg px-4 py-3 text-sm font-semibold text-center text-gray-700 peer-checked:border-purple-700 peer-checked:text-purple-700 peer-checked:bg-purple-50 hover:border-gray-400 transition">Yes</div>
                </label>
                <label class="flex-1 cursor-pointer">
                    <input type="radio" name="rss_feed_enabled" value="0"
                        {{ old('rss_feed_enabled', $episode->rss_feed_enabled ? '1' : '0') === '0' ? 'checked' : '' }} class="sr-only peer">
                    <div class="border border-gray-300 rounded-lg px-4 py-3 text-sm font-semibold text-center text-gray-700 peer-checked:border-purple-700 peer-checked:text-purple-700 peer-checked:bg-purple-50 hover:border-gray-400 transition">No</div>
                </label>
            </div>
        </div>
        ...
        <div class="mb-6">
            <label for="website_episode_notes" class="block text-sm font-semibold text-gray-700 mb-2">
                Episode Notes <span class="font-normal text-gray-400">(optional)</span>
            </label>
            ...
            <div class="flex gap-3">
                <label class="flex-1 cursor-pointer">
                    <input type="radio" name="website_enabled" value="1"
                        {{ old('website_enabled', $episode->website_enabled ? '1' : '0') === '1' ? 'checked' : '' }} class="sr-only peer">
                    <div class="border border-gray-300 rounded-lg px-4 py-3 text-sm font-semibold text-center text-gray-700 peer-checked:border-purple-700 peer-checked:text-purple-700 peer-checked:bg-purple-50 hover:border-gray-400 transition">Yes</div>
                </label>
                <label class="flex-1 cursor-pointer">
                    <input type="radio" name="website_enabled" value="0"
                        {{ old('website_enabled', $episode->website_enabled ? '1' : '0') === '0' ? 'checked' : '' }} class="sr-only peer">
                    <div class="border border-gray-300 rounded-lg px-4 py-3 text-sm font-semibold text-center text-gray-700 peer-checked:border-purple-700 peer-checked:text-purple-700 peer-checked:bg-purple-50 hover:border-gray-400 transition">No</div>
                </label>
            </div>
        </div>
