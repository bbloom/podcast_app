<x-layouts.app title="New Sponsor">
    ...
    <div class="mb-8">
        <div class="flex items-center gap-2 text-sm text-gray-500 mb-2">
            ...
            <span>›</span>
            <span class="text-gray-700">New Sponsor</span>
        </div>
        <h1 class="text-2xl font-bold text-gray-800">New Sponsor</h1>
    </div>

    <form method="POST" action="{{ route('phpserverlessproject_sponsors.store') }}">
        @csrf
        ...
        {{-- Website --}}
        <div class="mb-6">
            <label for="link_to_sponsor_website" class="block text-sm font-semibold text-gray-700 mb-2">
                Website <span class="font-normal text-gray-400">(optional)</span>
            </label>
            <input type="url" id="link_to_sponsor_website" name="link_to_sponsor_website" value="{{ old('link_to_sponsor_website') }}"
            ...
            <div class="flex gap-3">
                <label class="flex-1 cursor-pointer">
                    <input type="radio" name="umbrella_sponsor" value="1"
                        {{ old('umbrella_sponsor', '1') === '1' ? 'checked' : '' }} class="sr-only peer">
                ...
                <label class="flex-1 cursor-pointer">
                    <input type="radio" name="umbrella_sponsor" value="0"
                        {{ old('umbrella_sponsor', '1') === '0' ? 'checked' : '' }} class="sr-only peer">
            ...
            <div class="flex gap-3">
                <label class="flex-1 cursor-pointer">
                    <input type="radio" name="basecamp_sponsor" value="1"
                        {{ old('basecamp_sponsor', '0') === '1' ? 'checked' : '' }} class="sr-only peer">
                    <div class="border border-gray-300 rounded-lg px-4 py-3 text-sm font-semibold text-center text-gray-700 peer-checked:border-purple-700 peer-checked:text-purple-700 peer-checked:bg-purple-50 hover:border-gray-400 transition">Yes</div>
                </label>
                <label class="flex-1 cursor-pointer">
                    <input type="radio" name="basecamp_sponsor" value="0"
                        {{ old('basecamp_sponsor', '0') === '0' ? 'checked' : '' }} class="sr-only peer">
                    <div class="border border-gray-300 rounded-lg px-4 py-3 text-sm font-semibold text-center text-gray-700 peer-checked:border-purple-700 peer-checked:text-purple-700 peer-checked:bg-purple-50 hover:border-gray-400 transition">No</div>
                </label>
            </div>
            ...
            <div class="flex gap-3">
                <label class="flex-1 cursor-pointer">
                    <input type="radio" name="restream_sponsor" value="1"
                        {{ old('restream_sponsor', '0') === '1' ? 'checked' : '' }} class="sr-only peer">
                    <div class="border border-gray-300 rounded-lg px-4 py-3 text-sm font-semibold text-center text-gray-700 peer-checked:border-purple-700 peer-checked:text-purple-700 peer-checked:bg-purple-50 hover:border-gray-400 transition">Yes</div>
                </label>
                <label class="flex-1 cursor-pointer">
                    <input type="radio" name="restream_sponsor" value="0"
                        {{ old('restream_sponsor', '0') === '0' ? 'checked' : '' }} class="sr-only peer">
                    <div class="border border-gray-300 rounded-lg px-4 py-3 text-sm font-semibold text-center text-gray-700 peer-checked:border-purple-700 peer-checked:text-purple-700 peer-checked:bg-purple-50 hover:border-gray-400 transition">No</div>
                </label>
            </div>
            ...
            <div class="flex gap-3">
                <label class="flex-1 cursor-pointer">
                    <input type="radio" name="former_sponsor" value="1"
                        {{ old('former_sponsor', '0') === '1' ? 'checked' : '' }} class="sr-only peer">
                    <div class="border border-gray-300 rounded-lg px-4 py-3 text-sm font-semibold text-center text-gray-700 peer-checked:border-purple-700 peer-checked:text-purple-700 peer-checked:bg-purple-50 hover:border-gray-400 transition">Yes</div>
                </label>
                <label class="flex-1 cursor-pointer">
                    <input type="radio" name="former_sponsor" value="0"
                        {{ old('former_sponsor', '0') === '0' ? 'checked' : '' }} class="sr-only peer">
                    <div class="border border-gray-300 rounded-lg px-4 py-3 text-sm font-semibold text-center text-gray-700 peer-checked:border-purple-700 peer-checked:text-purple-700 peer-checked:bg-purple-50 hover:border-gray-400 transition">No</div>
                </label>
            </div>
