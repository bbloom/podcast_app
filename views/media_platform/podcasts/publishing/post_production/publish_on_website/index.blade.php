<x-layouts.app title="Publish on Website">
    ...
    @if ($episodes->isEmpty())
        ...
        <div class="rounded-lg border border-purple-200 bg-purple-50 px-6 py-10 text-center text-gray-500">
            <p class="text-lg font-medium text-purple-700">No episodes are ready to publish.</p>
            <p class="mt-2 text-sm">Once an episode's RSS feed has been promoted to live, it will appear here.</p>
        </div>
            ...
            <table class="w-full text-sm text-gray-700">
                <thead class="bg-purple-700 text-white text-left">
                    <tr>
                        ...
                        <th class="px-4 py-3 font-semibold">Publish On</th>
                ...
                <tbody class="divide-y divide-purple-100">
                    ...
                    <tr class="hover:bg-purple-50 transition-colors">
                        ...
                        <td class="px-4 py-3 text-gray-500">
                            {{ $episode->website_publish_on?->format('M j, Y') ?? '—' }}
                        </td>
