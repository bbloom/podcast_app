<x-layouts.app title="Auphonic Clean-Up Done — {{ $episode->title }}">

    <div class="flex items-center justify-between mb-6">
        <h1 class="text-3xl font-bold text-purple-700 tracking-wider">Auphonic Clean-Up Done</h1>
    ...
    <div class="mb-8 rounded-lg border border-green-300 bg-green-50 px-6 py-4">
        <p class="text-lg font-semibold text-green-700">&#10003; Auphonic clean-up complete.</p>
        <p class="mt-1 text-base text-green-600">
            The MP3 has been downloaded, the WAV recording deleted from S3, and the Auphonic
            production deleted. This episode is now ready for production audio upload.
        </p>
    </div>
        ...
        <div class="flex flex-col gap-4">
            <a href="{{ route('post_production.upload_production_audio.show', $episode) }}"
               class="flex items-center justify-between px-6 py-4 bg-purple-700 text-white rounded-lg font-semibold text-base hover:bg-purple-800 transition-colors">
                <span>Continue to Upload Production Audio</span>
