<x-layouts.app title="Upload Recording to S3">

    <div class="flex items-center justify-between mb-6">
        <h1 class="text-3xl font-bold text-purple-700 tracking-wider">Upload Recording to S3</h1>
                ...
                <tbody class="divide-y divide-purple-100">
                    ...
                    <tr class="hover:bg-purple-50 transition-colors">
                        ...
                        <td class="px-4 py-3 text-right">
                            <a href="{{ route('post_production.upload_recording.show', $episode) }}"
