<x-layouts.app title="RSS Feed Live — {{ $episode->title }}">

    <div class="flex items-center justify-between mb-6">
        <h1 class="text-3xl font-bold text-purple-700 tracking-wider">RSS Feed Live</h1>
    ...
    <div class="mb-8 rounded-lg border border-green-300 bg-green-50 px-6 py-4">
        <p class="text-lg font-semibold text-green-700">&#10003; RSS feed promoted to live.</p>
        <p class="mt-1 text-base text-green-600">
            The RSS feed has been uploaded to S3 and R2, and the staging and local files have been deleted.
            This episode is now ready to publish on the website.
        </p>
    </div>
