<x-layouts.app title="Episode Published — {{ $episode->title }}">

    <div class="flex items-center justify-between mb-6">
        <h1 class="text-3xl font-bold text-purple-700 tracking-wider">Episode Published</h1>
    ...
    <div class="mb-8 rounded-lg border border-green-300 bg-green-50 px-6 py-4">
        <p class="text-lg font-semibold text-green-700">&#10003; Episode fully published.</p>
        <p class="mt-1 text-base text-green-600">
            The RSS feed is live on S3 and Cloudflare R2. The website, audio file, and RSS
            feed are all published and available to Apple Podcasts, Spotify, and other directories.
        </p>
    </div>
