<x-layouts.app title="Generate RSS Feed">
    ...
    @if ($episodes->isEmpty())
        ...
        <div class="rounded-lg border border-purple-200 bg-purple-50 px-6 py-10 text-center text-gray-500">
            <p class="text-lg font-medium text-purple-700">No episodes are ready for RSS feed generation.</p>
            <p class="mt-2 text-sm">Once an episode's production audio has been uploaded to S3 and R2, it will appear here.</p>
        </div>
