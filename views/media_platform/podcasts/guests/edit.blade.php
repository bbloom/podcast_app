<x-layouts.app title="Edit Podcast Guest">
    ...
    <div class="mb-8">
        ...
        <h1 class="text-2xl font-bold text-gray-800">Edit Podcast Guest</h1>
    </div>

    <form method="POST" action="{{ route('podcast_guests.update', $guest) }}">
        @csrf
        @method('PUT')
        ...
        <div class="mb-6">
            ...
            <input type="text" id="full_name" name="full_name" value="{{ old('full_name', $guest->full_name) }}" required
        ...
        <div class="mb-6">
            ...
            <input type="email" id="email_address" name="email_address" value="{{ old('email_address', $guest->email_address) }}" required
        ...
        <div class="mb-6">
            ...
            <textarea id="profile_full" name="profile_full" rows="6" required
                class="w-full border border-gray-300 rounded-lg px-4 py-3 text-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition resize-none @error('profile_full') border-red-400 @enderror">{{ old('profile_full', $guest->profile_full) }}</textarea>
        ...
        <div class="mb-6">
            ...
            <input type="text" id="profile_short" name="profile_short" value="{{ old('profile_short', $guest->profile_short) }}"
        ...
        {{-- Website --}}
        <div class="mb-6">
            <label for="link_to_guest_website" class="block text-sm font-semibold text-gray-700 mb-2">Website</label>
            <input type="url" id="link_to_guest_website" name="link_to_guest_website" value="{{ old('link_to_guest_website', $guest->link_to_guest_website) }}"
        ...
        <div class="mb-6">
            ...
            <input type="url" id="image_url" name="image_url" value="{{ old('image_url', $guest->image_url) }}"
        ...
        <div class="mb-6">
            ...
            <input type="url" id="image_thumbnail_url" name="image_thumbnail_url" value="{{ old('image_thumbnail_url', $guest->image_thumbnail_url) }}"
            ...
            <div class="flex gap-3">
                <label class="flex-1 cursor-pointer">
                    <input type="radio" name="enabled" value="1"
                        {{ old('enabled', $guest->enabled ? '1' : '0') === '1' ? 'checked' : '' }} class="sr-only peer">
                ...
                <label class="flex-1 cursor-pointer">
                    <input type="radio" name="enabled" value="0"
                        {{ old('enabled', $guest->enabled ? '1' : '0') === '0' ? 'checked' : '' }} class="sr-only peer">
        ...
        <div class="mb-8">
            ...
            <textarea id="internal_comment" name="internal_comment" rows="3"
                class="w-full border border-gray-300 rounded-lg px-4 py-3 text-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition resize-none @error('internal_comment') border-red-400 @enderror">{{ old('internal_comment', $guest->internal_comment) }}</textarea>
