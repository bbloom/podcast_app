...
<div class="max-w-3xl mx-auto px-4 py-10">
    ...
    <x-podcasts.planning.finalize_script_wizard._step_dots :current="8" />

    <div class="text-center mb-8">
        <h1 class="text-3xl font-bold text-gray-800 mb-6">Finalize the Script Wizard</h1>
        <h1 class="text-3xl font-bold text-gray-800 mb-2">Step 8: Append the Outro</h1>
        <p class="text-base text-gray-500 mb-6">
            The outro template has been resolved with your episode details.
            <br>Edit if needed, then append — or skip if you have already added it manually.
        </p>
    ...
    <form method="POST" action="{{ route('podcast_episodes_planning.wizard.finalize.step8.store') }}">
        @csrf
        ...
        <div class="flex items-center justify-between">
            <a href="{{ route('podcast_episodes_planning.wizard.finalize.step7') }}"
