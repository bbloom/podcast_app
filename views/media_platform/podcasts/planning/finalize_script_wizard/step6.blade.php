...
<div class="max-w-3xl mx-auto px-4 py-10">
    ...
    <h1 class="text-2xl font-bold text-gray-800 mb-2 text-center">Append the Outro</h1>
    ...
    <form method="POST" action="{{ route('podcast_episodes_planning.wizard.finalize.step6.store') }}">
        ...
        <div class="mb-6">
            <label for="outro_text" class="block text-sm font-semibold text-gray-700 mb-1">Outro Text</label>
