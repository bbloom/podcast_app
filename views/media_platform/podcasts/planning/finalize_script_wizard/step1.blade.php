...
<div class="max-w-2xl mx-auto px-4 py-10">
    ...
    <div class="text-center mb-8">
        <h1 class="text-3xl font-bold text-gray-800 mb-3">Finalize the Script</h1>
        <p class="text-base text-gray-500 mb-1">{{ $episode->show->title ?? '' }} &mdash; {{ $episode->formatted_title }}</p>
    </div>

    <div class="border border-purple-300 rounded-lg p-6 bg-purple-50 text-base text-gray-700 space-y-2 mb-8">
