...
<div class="max-w-3xl mx-auto px-4 py-10">
    ...
    <h1 class="text-2xl font-bold text-gray-800 mb-2 text-center">Prepend the Intro</h1>
    ...
    <form method="POST" action="{{ route('podcast_episodes_planning.wizard.finalize.step5.store') }}">
        ...
        <div class="mb-6">
            <label for="intro_text" class="block text-sm font-semibold text-gray-700 mb-1">Intro Text</label>
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex gap-3">
                ...
                <button type="submit" name="_action" value="prepend"
                        class="px-5 py-2 bg-purple-700 text-white rounded hover:bg-purple-800 font-semibold text-sm">
                    Prepend to Script →
                </button>
            </div>
        </div>
