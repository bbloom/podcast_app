...
<div class="max-w-xl mx-auto px-4 py-10">
    ...
    <h1 class="text-2xl font-bold text-gray-800 mb-6 text-center">Confirm Episode Number</h1>

    <form method="POST" action="{{ route('podcast_episodes_planning.wizard.finalize.step2.store') }}">
        @csrf

        <div class="mb-6">
            <label for="episode_number" class="block text-sm font-semibold text-gray-700 mb-1">Episode Number</label>
